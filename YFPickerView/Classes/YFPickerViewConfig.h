...
#define kYFPickerViewDefaultThemeColor [UIColor colorWithRed:0.0 green:122.0/255.0 blue:1.0 alpha:1.0] // 默认主题颜色

@interface YFPickerViewConfig : NSObject
...
/** 设置 titleLabel 的 text（重要提示：多列时建议已选择的内容用英文逗号隔开，参考`YFPickerViewPropertyIsDividedSelectContentKey`这个key） */
